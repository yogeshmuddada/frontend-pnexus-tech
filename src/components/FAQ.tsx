...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "We recommend 2-3 hours daily - 1.5 hours for live sessions (Mon-Fri 7-9 PM) and 1-2 hours for practice and assignments. The more you practice, the better you'll become!"
    },
    {
    ...
    },
    {
      ...
      answer: "While we don't guarantee job placement, we provide comprehensive career guidance including resume review, portfolio optimization, interview preparation, and LinkedIn profile enhancement."
    },
    {
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem 
                key={index} 
                value={`item-${index}`}
                className="bg-gray-50 rounded-lg border-0 px-6"
              >
        ...
        <div className="max-w-2xl mx-auto mt-16 text-center">
          <div className="bg-gradient-to-r from-bootcamp-blue to-bootcamp-blue-dark rounded-2xl p-8 text-white">
            ...
            <div className="space-y-2">
              <p className="font-semibold">📧 durga.chikkala@email.com</p>
